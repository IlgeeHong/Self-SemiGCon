...
parser.add_argument('--drop_rate_edge', type=float, default=0.3)
parser.add_argument('--drop_rate_feat', type=float, default=0.3)
parser.add_argument('--result_file', type=str, default="/results/SelfGCon_node_classification_random")
...
def cl_loss_fn(z1, z2, mean = True):
    l1 = semi_loss(z1, z2)
    l2 = semi_loss(z2, z1)
    ret = (l1 + l2) * 0.5
...
for exp in range(args.n_experiments): 
    ...
    # edge_index_temp, _ = add_self_loops(data.edge_index, num_nodes = N)
